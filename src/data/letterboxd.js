/**
 * This is the code from zactopus's npm library, letterboxd (https://github.com/zactopus/letterboxd).
 * Due to a CORS error, I needed to use a proxy server to make my requests, so the only change is the proxy being appended to the URI
 */
