        ...
        <section id="about" className="about-section">
          ...
          <div className="about-content-container">
            ...
            <p className="about-content">
              I'm a second year SYDE student @ <a className="about-link" href="https://uwaterloo.ca/systems-design-engineering/" rel="noreferrer" target="_blank">uWaterloo</a> on my way through 2A <strong>(and seeking spring 2023 jobs!)</strong>.
              <br/><br/>
